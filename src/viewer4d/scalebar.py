"""Scale bar widget for pyqtgraph ImageView panels."""

from pyqtgraph import functions as fn
from pyqtgraph import getConfigOption, Point, GraphicsObject, GraphicsWidgetAnchor, TextItem
...
class ScaleBar(GraphicsWidgetAnchor, GraphicsObject):
    """Displays a rectangular bar indicating the relative scale of the view."""
    ...
    def updateBar(self):
        ...
        self.text.setText(
            f"{sigfig_round(nice_size, sigfigs=1, output_type=str)} {self.units}"
        )
